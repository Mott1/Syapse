...
var LogoGrid = function () {
	function LogoGrid(target, index) {
		_classCallCheck(this, LogoGrid);

		this.initVars(target, index);
		this.initEvents();
	}

	_createClass(LogoGrid, [{
		key: "initVars",
		value: function initVars(target, index) {

			var _this = this;

			// this.target = target.querySelector('.logos-container');

			// this.logoGridDraggable = Draggable.create(this.target, {type:"scrollLeft", edgeResistance:0.5, throwProps:true});
		}
	}, {
		key: "initEvents",
		...
		// 	this.logoGridDraggable[0].enable();

		// }

		// setDisable() {

		// 	this.logoGridDraggable[0].disable();
...
var Reveal = function () {
	...
	_createClass(Reveal, [{
		...
		value: function update() {
			...
			var newOffsetMultipler = this.offsetMultipler;

			if (isMobile) {
				var _newOffsetMultipler = this.offsetMultiplerMobile;
			}
